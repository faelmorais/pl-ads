...
import wx
import db_setup
from repositorio_imc import imc_repository
...
class CalculadoraImc(wx.Frame):
    ...
    def calcular_imc(self, event):
        try:
            ...
            endereco = self.input_endereco.GetValue()
            imc_repository.add_registro(nome, endereco, altura, peso, imc, classe_imc)
            imc_repository.print_all()
        except ValueError:
